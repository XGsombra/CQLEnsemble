...
register(
    ...
    kwargs={
        'flow_params': ring_env(render=False),
        'dataset_url':'gs://d4rl-data/offline_rl/flow/flow-ring-v0-random.hdf5',
        'ref_min_score': RING_RANDOM_SCORE,
        'ref_max_score': RING_EXPERT_SCORE
    }
)
...
register(
    ...
    kwargs={
        'flow_params': ring_env(render=False),
        'dataset_url':'gs://d4rl-data/offline_rl/flow/flow-ring-v0-idm.hdf5',
        'ref_min_score': RING_RANDOM_SCORE,
        'ref_max_score': RING_EXPERT_SCORE
    }
)
...
register(
    ...
    kwargs={
        'flow_params': merge.gen_env(render=False),
        'dataset_url':'gs://d4rl-data/offline_rl/flow/flow-merge-v0-random.hdf5',
        'ref_min_score': MERGE_RANDOM_SCORE,
        'ref_max_score': MERGE_EXPERT_SCORE
    }
)
...
register(
    ...
    kwargs={
        'flow_params': merge.gen_env(render=False),
        'dataset_url':'gs://d4rl-data/offline_rl/flow/flow-merge-v0-idm.hdf5',
        'ref_min_score': MERGE_RANDOM_SCORE,
        'ref_max_score': MERGE_EXPERT_SCORE
    }
)
