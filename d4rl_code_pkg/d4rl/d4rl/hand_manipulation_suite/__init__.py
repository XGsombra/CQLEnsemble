...
register(
    ...
    kwargs={
        ...
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/door-v0_demos_clipped.hdf5'
    }
)
...
register(
    ...
    kwargs={
        'ref_min_score': DOOR_RANDOM_SCORE,
        'ref_max_score': DOOR_EXPERT_SCORE,
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/door-demos-v0-bc-combined.hdf5'
    }
)
...
register(
    ...
    kwargs={
        'ref_min_score': DOOR_RANDOM_SCORE,
        'ref_max_score': DOOR_EXPERT_SCORE,
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/door-v0_expert_clipped.hdf5'
    }
)
...
register(
    ...
    kwargs={
        ...
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/hammer-v0_demos_clipped.hdf5'
    }
)
...
register(
    ...
    kwargs={
        'ref_min_score': HAMMER_RANDOM_SCORE,
        'ref_max_score': HAMMER_EXPERT_SCORE,
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/hammer-demos-v0-bc-combined.hdf5'
    }
)
...
register(
    ...
    kwargs={
        'ref_min_score': HAMMER_RANDOM_SCORE,
        'ref_max_score': HAMMER_EXPERT_SCORE,
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/hammer-v0_expert_clipped.hdf5'
    }
)
...
register(
    ...
    kwargs={
        ...
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/pen-v0_demos_clipped.hdf5'
    }
)
...
register(
    ...
    kwargs={
        'ref_min_score': PEN_RANDOM_SCORE,
        'ref_max_score': PEN_EXPERT_SCORE,
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/pen-demos-v0-bc-combined.hdf5'
    }
)
...
register(
    ...
    kwargs={
        'ref_min_score': PEN_RANDOM_SCORE,
        'ref_max_score': PEN_EXPERT_SCORE,
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/pen-v0_expert_clipped.hdf5'
    }
)
...
register(
    ...
    kwargs={
        ...
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/relocate-v0_demos_clipped.hdf5'
    }
)
...
register(
    ...
    kwargs={
        'ref_min_score': RELOCATE_RANDOM_SCORE,
        'ref_max_score': RELOCATE_EXPERT_SCORE,
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/relocate-demos-v0-bc-combined.hdf5'
    }
)
...
register(
    ...
    kwargs={
        'ref_min_score': RELOCATE_RANDOM_SCORE,
        'ref_max_score': RELOCATE_EXPERT_SCORE,
        'dataset_url':'gs://d4rl-data/offline_rl/hand_dapg/relocate-v0_expert_clipped.hdf5'
    }
)
