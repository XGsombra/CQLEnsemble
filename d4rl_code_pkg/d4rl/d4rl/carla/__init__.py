...
register(
    ...
    kwargs={
        ...
        'dataset_url': 'gs://d4rl-data/offline_rl/carla/carla_lane_follow_flat-v0.hdf5',
...
register(
    ...
    kwargs={
        'ref_min_score': -0.8503839912088142,
        'ref_max_score': 1023.5784385429523, 
        'dataset_url': 'gs://d4rl-data/offline_rl/carla/carla_lane_follow-v0.hdf5',
        'reward_type': 'lane_follow',
        'carla_args': dict(
            vision_size=48,
            vision_fov=48,
...
register(
    ...
    kwargs={
        ...
        'dataset_url': 'gs://d4rl-data/offline_rl/carla/carla_town_subsamp_flat-v0.hdf5',
...
register(
    ...
    kwargs={
        'ref_min_score': -122.228455,
        'ref_max_score': -64.62967840318221,
        'dataset_url': 'gs://d4rl-data/offline_rl/carla/carla_town_flat-v0.hdf5',
        'reward_type': 'goal_reaching',
        'carla_args': dict(
            vision_size=48,
            vision_fov=48,
...
register(
    ...
    kwargs={
        'ref_min_score': -122.228455,
        'ref_max_score': -64.62967840318221,
        'dataset_url': 'gs://d4rl-data/offline_rl/carla/carla_town_subsamp-v0.hdf5',
        'reward_type': 'goal_reaching',
        'carla_args': dict(
            vision_size=48,
            vision_fov=48,
...
register(
    ...
    kwargs={
        'ref_min_score': 0.0,
        'ref_max_score': 1.0,
        'dataset_url': 'gs://d4rl-data/offline_rl/carla/carla_town-v0.hdf5',
        'reward_type': 'goal_reaching',
        'carla_args': dict(
            vision_size=48,
            vision_fov=48,
